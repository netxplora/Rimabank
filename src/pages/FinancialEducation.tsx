...
export default function FinancialEducation() {
  ...
  return (
    <Layout>
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          <div className="max-w-3xl space-y-6">
            ...
            <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-semibold text-[#0a1e3f] tracking-tight leading-[1.05]">
              Practical financial <span className="text-[#0284c7]">guides & insights</span>.
            </h1>
      ...
      <section className="py-6 bg-white border-b border-[#e2e8f0]/60">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-xs font-semibold uppercase tracking-wider transition-all ${
                    activeCategory === cat
                      ...
                      : "bg-[#f0f7ff] text-[#0a1e3f] hover:bg-[#e2e8f0]"
                  }`}
                >
                  {cat}
                </button>
            ...
            <div className="relative w-full lg:w-80">
              ...
              <Input
                ...
                className="pl-10 h-10 bg-[#f0f7ff]/40 border-[#e2e8f0] rounded-xl text-xs text-[#0a1e3f] focus:border-[#0284c7]"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 bg-white border-b border-[#e2e8f0]/60">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-12">
          {filteredArticles.map((article, idx) => (
            <div
              key={idx}
              className="flex flex-col justify-between group border-t border-[#e2e8f0]/80 pt-6"
            >
              <div>
                ...
                <div className="flex items-start gap-3.5 mb-3">
                  ...
                  <h3 className="font-heading text-lg font-semibold text-[#0a1e3f] group-hover:text-[#0284c7] transition-colors leading-snug">
                    {article.title}
                  </h3>
                </div>
              ...
              <div className="pt-3 border-t border-[#e2e8f0]/60">
                <span className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-[#0284c7] group-hover:text-[#0369a1]">
