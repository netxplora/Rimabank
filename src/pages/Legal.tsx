...
const legalContent = {
  privacy: {
    ...
    icon: <ShieldAlert className="h-6 w-6 text-[#0284c7]" />,
    content: (
      <div className="space-y-6 text-[#0a1e3f]/80 text-xs leading-relaxed">
        <p className="text-[11px] text-[#64748b] font-medium pb-4 border-b border-[#e2e8f0]/60">
          Last updated: September 2026 &bull; Compliant with Nigeria Data Protection Act (NDPA)
        </p>

        <section>
          <p className="text-sm font-normal text-[#0a1e3f] leading-relaxed">
        ...
        <section className="space-y-3">
          <h3 className="font-heading text-base font-semibold text-[#0a1e3f] flex items-center gap-2">
            <span className="bg-[#f0f7ff] text-[#0284c7] w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold">1</span>
            Information We Collect
          </h3>
          <p>We collect essential customer data to provide secure banking operations and comply with regulatory directives:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[#0a1e3f]/70">
        ...
        <section className="space-y-3">
          <h3 className="font-heading text-base font-semibold text-[#0a1e3f] flex items-center gap-2">
            <span className="bg-[#f0f7ff] text-[#0284c7] w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold">2</span>
        ...
        <section className="space-y-3">
          <h3 className="font-heading text-base font-semibold text-[#0a1e3f] flex items-center gap-2">
            <span className="bg-[#f0f7ff] text-[#0284c7] w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold">3</span>
        ...
        <div className="p-6 rounded-2xl bg-[#f0f7ff] border border-[#e2e8f0] mt-8">
          <h4 className="font-heading text-xs font-bold text-[#0a1e3f] mb-1">Data Protection Officer</h4>
          <p className="text-[11px] text-[#64748b]">
            Direct inquiries regarding your privacy rights to <a href="mailto:dpo@rimamfb.com" className="text-[#0284c7] font-semibold underline">dpo@rimamfb.com</a>.
          </p>
        </div>
      </div>
    )
  ...
  cookies: {
    ...
    icon: <AlertCircle className="h-6 w-6 text-[#0284c7]" />,
    content: (
      <div className="space-y-6 text-[#0a1e3f]/80 text-xs leading-relaxed">
        <p className="text-[11px] text-[#64748b] font-medium pb-4 border-b border-[#e2e8f0]/60">
        ...
        <section className="space-y-3">
          <h3 className="font-heading text-base font-semibold text-[#0a1e3f]">Cookie Classifications</h3>
          <div className="space-y-3">
            <div className="p-4 rounded-xl bg-[#f0f7ff] border border-[#e2e8f0]">
              <strong className="text-[#0a1e3f] block mb-1">Essential Security Cookies</strong>
              Required for session management, internet banking encryption, and CSRF token validation.
            </div>
            <div className="p-4 rounded-xl bg-[#f0f7ff] border border-[#e2e8f0]">
              <strong className="text-[#0a1e3f] block mb-1">Performance & Telemetry Cookies</strong>
  ...
  complaints: {
    ...
    icon: <MessageSquare className="h-6 w-6 text-[#0284c7]" />,
    content: (
      <div className="space-y-6 text-[#0a1e3f]/80 text-xs leading-relaxed">
        <p className="text-[11px] text-[#64748b] font-medium pb-4 border-b border-[#e2e8f0]/60">
        ...
        <section className="space-y-3">
          <h3 className="font-heading text-base font-semibold text-[#0a1e3f]">Resolution Timelines</h3>
          <ul className="list-disc pl-5 space-y-1.5 text-[#0a1e3f]/70">
        ...
        <div className="p-6 rounded-2xl bg-white border border-[#e2e8f0] shadow-lift space-y-2 mt-6">
          <h4 className="font-heading text-xs font-bold text-[#0a1e3f]">Escalation Contact</h4>
          <p className="text-[11px] text-[#64748b]">
            If a dispute remains unresolved after 14 days, you may escalate the matter directly to the Central Bank of Nigeria Consumer Protection Department via <a href="mailto:cpd@cbn.gov.ng" className="text-[#0284c7] underline">cpd@cbn.gov.ng</a>.
          </p>
        </div>
      </div>
    )
                ...
                <button
                  ...
                  className={`flex items-center justify-between w-full px-5 py-3.5 rounded-2xl text-xs font-semibold transition-all ${
                    activeTab === key
                      ...
                      : "bg-white text-[#0a1e3f]/80 hover:bg-[#f0f7ff] border border-[#e2e8f0]"
                  }`}
                >
            ...
            <div className="lg:col-span-8">
              <div className="p-6 sm:p-10 lg:p-12 rounded-3xl bg-white border border-[#e2e8f0] space-y-6">
                <div className="flex items-center gap-3 pb-5 border-b border-[#e2e8f0]/60">
                  ...
                  <h2 className="font-heading text-2xl font-semibold text-[#0a1e3f]">
