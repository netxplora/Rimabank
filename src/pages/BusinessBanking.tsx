                  ...
                  <Accordion type="single" collapsible className="w-full mb-6">
                    <AccordionItem value="requirements" className="border-slate-200">
                      <AccordionTrigger className="py-2 text-xs font-semibold text-[#0a1e3f] hover:no-underline">
                        Documentation & CAC Requirements
                      </AccordionTrigger>
                      <AccordionContent>
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                {[
                  ...
                  <div key={i} className="flex items-start gap-2.5 p-3 rounded-2xl bg-white border border-[#e2e8f0] shadow-xs">
            ...
            <div className="lg:col-span-5 perspective-1000">
              <div className="rounded-3xl bg-white border border-[#e2e8f0] p-6 sm:p-8 space-y-4 shadow-sm">
                ...
                <div className="space-y-3 text-xs text-[#0a1e3f]/85">
                  ...
                  <div className="p-4 rounded-2xl bg-[#f0f7ff] border border-[#e2e8f0]">
                    <span className="font-semibold text-[#0a1e3f] block mb-2">Documentation Requirements:</span>
