                  ...
                  filteredBranches.map(branch => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-3">
                        <h3 className={cn("font-heading text-base font-semibold", activeBranchId === branch.id ? "text-[#f73b20]" : "text-[#360802]")}>
                          {branch.name}
                        </h3>
                        {activeBranchId === branch.id && (
                      ...
                      <div className="space-y-2 text-xs text-[#360802]/85">
                        ...
                        <div className="flex items-center gap-2">
                          <Clock className="h-3.5 w-3.5 text-[#ababab] shrink-0" />
                          <span>{branch.opening_hours || "Mon - Fri: 8:00 AM - 4:00 PM"}</span>
                        </div>
                      </div>

                      <div className="mt-4 pt-3 border-t border-[#e7dcdb]/60 flex gap-3">
                        <Button
                          size="sm"
                        ...
                        <Button size="sm" variant="outlineNeutral" className="flex-1 text-xs rounded-full" asChild>
                          ...
                          >
                            <Navigation className="mr-1.5 h-3.5 w-3.5 text-[#f73b20]" />
                            Directions
                          </a>
                        </Button>
                      </div>
              ...
              <div className="lg:sticky lg:top-24">
                <div className="rounded-3xl overflow-hidden h-[400px] lg:h-[650px] border border-[#e7dcdb] shadow-3d-lift bg-[#fdedea] relative">
                  {activeBranch && activeBranch.latitude && activeBranch.longitude ? (
                    ...
                    <div className="w-full h-full flex flex-col items-center justify-center text-[#ababab] p-6 text-center">
                      <MapPin className="h-8 w-8 text-[#f73b20] mb-2" />
                      <h3 className="font-heading font-semibold text-sm text-[#360802]">Select a Branch</h3>
                      <p className="text-xs text-[#ababab]">Click any branch from the list to view its map location.</p>
                    </div>
                  )}
                </div>
              </div>
