  ...
  return (
    <Layout>
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          <div className="max-w-3xl space-y-6">
            ...
            <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-semibold text-[#0a1e3f] tracking-tight leading-[1.05]">
              Forms, documents & <span className="text-[#0284c7]">downloads</span>.
            </h1>
      ...
      <section className="py-16 md:py-20 bg-white border-b border-[#e2e8f0]/60">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 border-t border-[#e2e8f0]/80 pt-10">
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <h3 className="font-heading text-lg font-semibold text-[#0a1e3f] mb-1.5">Mobile Applications</h3>
              ...
              <div className="divide-y divide-[#e2e8f0]/70 border-t border-b border-[#e2e8f0]/70">
                <a
                  ...
                  className="flex items-center justify-between py-3 text-xs font-semibold text-[#0a1e3f] hover:text-[#0284c7] transition-colors"
                >
                  <span className="flex items-center gap-2">
                    <Download className="h-4 w-4 text-[#0284c7]" />
                    Android Package (APK)
                  </span>
                  <span className="text-[10px] text-[#64748b]">v2.4.1</span>
                </a>
                ...
                >
                  ...
                  <span className="text-[10px] text-[#64748b]">iOS 13+</span>
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <h3 className="font-heading text-lg font-semibold text-[#0a1e3f] mb-1.5">Account Opening Forms</h3>
              <p className="text-xs text-[#64748b] leading-relaxed mb-5">
              ...
              <div className="divide-y divide-[#e2e8f0]/70 border-t border-b border-[#e2e8f0]/70">
                ...
                >
                  ...
                  <span className="text-[10px] text-[#64748b]">1.2 MB</span>
                </a>
                ...
                >
                  ...
                  <span className="text-[10px] text-[#64748b]">1.8 MB</span>
                </a>
                ...
                >
                  ...
                  <span className="text-[10px] text-[#64748b]">0.8 MB</span>
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <h3 className="font-heading text-lg font-semibold text-[#0a1e3f] mb-1.5">Policies & Disclosures</h3>
              <p className="text-xs text-[#64748b] leading-relaxed mb-5">
              ...
              <div className="divide-y divide-[#e2e8f0]/70 border-t border-b border-[#e2e8f0]/70">
                ...
                >
                  ...
                  <span className="text-[10px] text-[#64748b]">2.1 MB</span>
                </a>
              </div>
            </div>
          </div>
