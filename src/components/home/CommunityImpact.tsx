...
export function CommunityImpact() {
  ...
  return (
    <section className="py-24 bg-white border-b border-[#e2e8f0]/60 overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-pills bg-[#f0f7ff] border border-[#e2e8f0] text-[#0284c7] text-xs font-semibold uppercase tracking-ui">
              <span>Socio-Economic Impact</span>
            </div>

            <h2 className="font-heading text-3xl sm:text-5xl font-medium text-[#0a1e3f] tracking-tight leading-[1.05]">
              Empowering regional economic <span className="text-[#0284c7]">stability & enterprise</span>.
            </h2>

            <p className="text-xs sm:text-sm text-[#0a1e3f]/80 leading-relaxed max-w-xl">
          ...
          <div className="lg:col-span-5">
            <div className="rounded-cards overflow-hidden shadow-lift border border-[#e2e8f0] aspect-[4/5] relative">
              <img 
