          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <Button
                ...
                size="xl"
                asChild
                className="bg-[#0284c7] hover:bg-[#0369a1] text-white shadow-[0_10px_24px_rgba(2,132,199,0.3)] hover:shadow-[0_14px_30px_rgba(2,132,199,0.45)] transform hover:-translate-y-1 active:scale-95 transition-all duration-200"
              >
                <Link to="/contact">
                  Open an Account
              ...
              <Button
                ...
                size="xl"
                asChild
                className="rounded-full bg-white/80 hover:bg-white text-[#0a1e3f] border-[#cbd5e1] hover:border-[#0a1e3f] backdrop-blur-md shadow-sm transform hover:-translate-y-1 active:scale-95 transition-all duration-200"
              >
            ...
            {/* Micro Trust Grid — always 3 columns (single horizontal row on all screens) */}
            <div className="pt-6 border-t border-[#cbd5e1]/60 grid grid-cols-3 gap-2 sm:gap-4 text-xs font-semibold text-[#0a1e3f]">
              <div className="flex items-center gap-1.5 sm:gap-2.5 bg-white/85 border border-[#e2e8f0] rounded-xl p-2 sm:p-2.5 backdrop-blur-sm shadow-xs transition-transform hover:-translate-y-0.5 duration-200">
                <ShieldCheck className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[#16a34a] shrink-0" />
                <span className="leading-tight">Zero Opening Fee</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2.5 bg-white/85 border border-[#e2e8f0] rounded-xl p-2 sm:p-2.5 backdrop-blur-sm shadow-xs transition-transform hover:-translate-y-0.5 duration-200">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2.5 bg-white/85 border border-[#e2e8f0] rounded-xl p-2 sm:p-2.5 backdrop-blur-sm shadow-xs transition-transform hover:-translate-y-0.5 duration-200">
                ...
                <span className="leading-tight">50,000+ Accounts</span>
              </div>
            </div>
          </div>

          {/* Right Floating Showcase Panel (5 cols) */}
          <div className="lg:col-span-5 relative perspective-1000 animate-scale-in">
            ...
            <div className="bg-white/90 border border-white rounded-2xl p-6 sm:p-8 transform-3d-card shadow-2xl backdrop-blur-lg space-y-6">
              <div className="flex items-center justify-between pb-4 border-b border-[#e2e8f0]">
                ...
                <div className="w-10 h-10 rounded-xl bg-[#0284c7] text-white flex items-center justify-center font-bold text-sm shadow-md animate-pulse">
                  12.5%
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-[#f0f7ff] rounded-xl p-3.5 border border-[#e0f2fe] hover:bg-[#e0f2fe]/60 hover:-translate-y-0.5 transition-all duration-200">
