          ...
          {trustStats.map((stat, index) => {
            ...
            return (
              <div
                ...
                } ${index > 0 ? "lg:border-l lg:border-[#e2e8f0]" : ""} hover:bg-slate-50 transition-colors`}
              >
                <div className="flex items-center gap-1.5 sm:gap-2 mb-1.5">
                  <div
                    className="w-6 h-6 sm:w-6.5 sm:h-6.5 rounded-lg flex items-center justify-center shrink-0 shadow-sm"
